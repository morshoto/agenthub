...
func TestSaveAndLoadRoundTrip(t *testing.T) {
	...
	cfg := &Config{
		...
		GitHub:   GitHubConfig{AuthMode: GitHubAuthModeApp, AppID: "123456", InstallationID: "789012", PrivateKeySecretARN: "arn:aws:secretsmanager:ap-northeast-1:123456789012:secret:agenthub/github-app-private-key"},
	...
	if loaded.Platform.Name != cfg.Platform.Name || loaded.Compute.Class != cfg.Compute.Class || loaded.Image.ID != cfg.Image.ID || loaded.Runtime.Provider != "codex" || loaded.Runtime.Codex.SecretID != cfg.Runtime.Codex.SecretID || loaded.GitHub.PrivateKeySecretARN != cfg.GitHub.PrivateKeySecretARN || loaded.GitHub.AuthMode != cfg.GitHub.AuthMode || loaded.Sandbox.NetworkMode != "private" || !loaded.Sandbox.UseNemoClaw {
